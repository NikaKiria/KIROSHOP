...
const getOrdersRoute = require("./routes/orders/get-orders/getOrders.js");
const deleteOrderRoute = require("./routes/orders/delete-order/deleteOrder.js");
// Create express app
const app = express();
...
app.use("/api/v1", getOrdersRoute);
app.use("/api/v1", deleteOrderRoute);
